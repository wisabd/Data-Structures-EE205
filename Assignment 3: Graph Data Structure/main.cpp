...
int main() {
	...
	temp_node = *(test_graph->get_ADT_nodelist().get_node_list().begin());
	cout << "selected node is "<<temp_node->get_node_name()<<endl;
	cout << "Is it adjacenet to node B? " << (temp_node->isAdjacentTo("B") ? "yes":"no") <<endl ; 
	cout << "Is it adjacenet to node C? " << (temp_node->isAdjacentTo("C") ? "yes":"no") << endl; 
	cout << endl << endl; 
	...
	test_graph->eraseVertex("D"); 
	cout <<endl<<endl;
	cout << "Test3: remove D" << endl; 
	...
	cout << "Is it adjacenet to node B? " << (temp_node->isAdjacentTo("B") ? "yes":"no") <<endl ; 
	cout << "Is it adjacenet to node C? " << (temp_node->isAdjacentTo("C") ? "yes":"no") << endl; 
	cout << "Is it adjacenet to node D? " << (temp_node->isAdjacentTo("D") ? "yes":"no") <<endl ; 
	cout << "Is it adjacenet to node E? " << (temp_node->isAdjacentTo("E") ? "yes":"no") <<endl ; 
